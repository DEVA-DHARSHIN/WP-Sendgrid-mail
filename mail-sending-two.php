...
function display_ing() {
    echo '
    <div class="content">
        <h2><b><i>Great ease of use</i></b></h2>
        <h2><b><i>and deliverability</i></b></h2>
...
// <img src="' . plugins_url('images/logo.png', __FILE__) . '" class="sendgrid-logo" />
function email_sender_form() {
    ...
    echo '
    <div class="container">
        <div class="content">' . display_ing() . '</div>
